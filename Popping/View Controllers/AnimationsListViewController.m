...
/*
 ...
 [self.navigationController pushViewController:[[DemoViewController alloc]initWithNibName:@"DemoViewController" bundle:nil]  animated:YES];
 else
 {
...
- (void)configureTableView
{
    self.items = @[@[@"Position Animation", [ViewController class]],
                   @[@"Slide Animation", [DemoViewController class]],
